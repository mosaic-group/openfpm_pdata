...
public:
    ...
    Neighborhood(ParticleData<ParticleType>& particle_data_in) : particle_data(particle_data_in) {}
...
public:
    ...
    NeighborhoodAll(ParticleData<ParticleType>& particle_data_in) : Neighborhood<ParticleType>(particle_data_in), iterator(particle_data_in.vd.getDomainIterator()) {}
...
template <typename ParticleType, typename NeighborFunction = NeighborhoodAll<ParticleType>>
...
class TestPM : public ParticleMethod<particle_type, NeighborhoodCellList<particle_type>> {
