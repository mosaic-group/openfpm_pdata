...
for i in range(len(files_to_convert)):
    ...
    hip_com = "hipify-clang -skip-excluded-preprocessor-conditional-blocks -D__HIPIFY__  -D__NVCC__ -D__CUDACC_VER_MAJOR__=10 -D__CUDACC_VER_MINOR__=1 -D__CUDACC_VER_MINOR__ -D__CUDACC_VER_BUILD__=243 " + str(files_to_convert[i])
...
for i in range(len(cudaFileToParse)):
    ...
    hip_com = "hipify-clang -skip-excluded-preprocessor-conditional-blocks -D__HIPIFY__  -D__NVCC__ -D__CUDACC_VER_MAJOR__=10 -D__CUDACC_VER_MINOR__=1 -D__CUDACC_VER_MINOR__ -D__CUDACC_VER_BUILD__=243 " + cudaFileToParse[i]
