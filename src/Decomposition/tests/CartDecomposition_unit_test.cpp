...
BOOST_AUTO_TEST_CASE( CartDecomposition_non_periodic_test_ORB)
{
	// Vcluster
	Vcluster<> & vcl = create_vcluster();

	typedef CartDecomposition<3, float, HeapMemory,memory_traits_lin, OrbDecompositionStrategy<3,float>, SequentialDistributionStrategy<3,float>, dec_optimizer<3, Graph_CSR<nm_v<3>, nm_e>> > DecType;
