...
BOOST_AUTO_TEST_CASE( vector_dist_multiphase_kernel_test )
{
	...
	for (size_t i = 0 ; i < 100 ; i++)
	{
		...
		phases.template get<0>(0).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.template get<0>(0).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.template get<0>(0).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.template get<0>(0).getLastPropWrite<0>() = (double)rand() / RAND_MAX;

		phases.template get<0>(1).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.template get<0>(1).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.template get<0>(1).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.template get<0>(1).getLastPropWrite<0>() = (double)rand() / RAND_MAX;

		phases.template get<0>(2).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.template get<0>(2).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.template get<0>(2).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.template get<0>(2).getLastPropWrite<0>() = (double)rand() / RAND_MAX;

		phases.template get<0>(3).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.template get<0>(3).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.template get<0>(3).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.template get<0>(3).getLastPropWrite<0>() = (double)rand() / RAND_MAX;
	}
...
BOOST_AUTO_TEST_CASE( vector_dist_multiphase_kernel_test_simplified )
{
	...
	for (size_t i = 0 ; i < 100 ; i++)
	{
		...
		phases.get(0).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.get(0).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.get(0).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.get(0).getLastPropWrite<0>() = (double)rand() / RAND_MAX;

		phases.get(1).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.get(1).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.get(1).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.get(1).getLastPropWrite<0>() = (double)rand() / RAND_MAX;

		phases.get(2).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.get(2).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.get(2).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.get(2).getLastPropWrite<0>() = (double)rand() / RAND_MAX;

		phases.get(3).getLastPosWrite()[0] = (double)rand() / RAND_MAX;
		phases.get(3).getLastPosWrite()[1] = (double)rand() / RAND_MAX;
		phases.get(3).getLastPosWrite()[2] = (double)rand() / RAND_MAX;
		phases.get(3).getLastPropWrite<0>() = (double)rand() / RAND_MAX;
	}
