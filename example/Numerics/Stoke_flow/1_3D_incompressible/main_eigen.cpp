/*!
 * \page Stokes_1_3D Stokes incompressible 3D eigen
 *
 * # Stokes incompressible 3D # {#num_sk_inc_3D}
 *
 ...
 * about the system
 *
 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp def system
 *
 */
 ...
 * \page Stokes_1_3D Stokes incompressible 3D eigen
 *
 * ## System of equation modeling ## {#num_sk_inc_3D_sem}
 *
 ...
 *
 *
 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp def equation
 *
 */
 ...
 *
 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp bond def eq
 *
 */
...
int main(int argc, char* argv[])
{
	 ...
	 * \page Stokes_1_3D Stokes incompressible 3D eigen
	 *
	 * ## Initialization ## {#num_sk_inc_3D_init}
	 *
	 ...
	 *
	 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp grid inst
	 *
	 */
	 ...
	 *
	 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp fd scheme
	 *
	 */
	 ...
	 *
	 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp impose eq dom
	 *
	 *
	 */
	 ...
	 * \page Stokes_1_3D Stokes incompressible 3D eigen
	 *
	 * ## Solve the system of equation ## {#num_sk_inc_3D_sse}
	 *
	 ...
	 *
	 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp solver
	 *
	 */
	 ...
	 * \page Stokes_1_3D Stokes incompressible 3D eigen
	 *
	 * ## Copy the solution on the grid and write on VTK ## {#num_sk_inc_3D_csg}
	 *
	 * Once we have the solution we copy it on the grid
	 *
	 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp copy write
	 *
	 */
	 ...
	 * \page Stokes_1_3D Stokes incompressible 3D eigen
	 *
	 * ## Finalize ## {#num_sk_inc_3D_fin}
	 *
	 *  At the very end of the program we have always to de-initialize the library
	 *
	 * \snippet Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp fin lib
	 *
	 */
	 ...
	 * \page Stokes_1_3D Stokes incompressible 3D eigen
	 *
	 * # Full code # {#num_sk_inc_3D_code}
	 *
	 * \include Numerics/Stoke_flow/1_3D_incompressible/main_eigen.cpp
	 *
	 */
}
